...
def prepare_data(series, n_test, n_lag):
	# extract raw values
...
def plot_forecasts(series, forecasts, n_test):
	...
	# show the plot
	pyplot.savefig('LSTM_by_multistep.jpeg')
 
# load dataset
series = read_csv('LSTM_bystep1.csv', usecols=[0])
# configure
n_lag = 1
n_seq = 3
n_test = 10
...
n_neurons = 1
# prepare data
scaler, train, test = prepare_data(series, n_test, n_lag)
# fit model
